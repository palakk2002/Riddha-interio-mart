      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-[40px] p-8 md:p-12 shadow-sm border border-soft-oatmeal flex flex-col md:flex-row items-center gap-10">
          <div className="relative group">
            <div className="h-36 w-36 rounded-full bg-warm-sand/10 border-4 border-white shadow-xl flex items-center justify-center overflow-hidden">
               <FiUser className="h-16 w-16 text-warm-sand/40" />
          ...
          <div className="text-center md:text-left flex-1">
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-2">
              <span className="px-3 py-1 bg-warm-sand text-white text-[10px] font-black uppercase tracking-widest rounded-full">
                {sellerInfo.tier}
              </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <div className="flex items-center gap-3 text-sm font-medium text-warm-sand">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
           ...
           <div className="lg:col-span-2 grid grid-cols-2 gap-6">
              {[
                ...
                { label: 'Join Date', value: sellerInfo.joinDate, icon: <FiUser />, color: 'bg-warm-sand' },
              ].map((stat, i) => (
              ...
              <div className="col-span-2 bg-white p-8 rounded-[32px] border border-soft-oatmeal shadow-sm">
                 ...
                 <div className="space-y-6">
                    <div className="flex justify-between items-center py-3 border-b border-soft-oatmeal/50">
                       <span className="text-xs font-bold text-dusty-cocoa uppercase tracking-widest">Business License</span>
                       <span className="text-sm font-black text-deep-espresso">Verified (GST-IN: 09AAFCR...)</span>
                    </div>
                    <div className="flex justify-between items-center py-3 border-b border-soft-oatmeal/50">
                       <span className="text-xs font-bold text-dusty-cocoa uppercase tracking-widest">Payout Schedule</span>
                       <span className="text-sm font-black text-deep-espresso">Every Friday</span>
                    </div>
                    <div className="flex justify-between items-center py-3">
                       <span className="text-xs font-bold text-dusty-cocoa uppercase tracking-widest">Store Status</span>
                 ...
                 <div className="space-y-4">
                    <button className="w-full flex items-center justify-between p-4 rounded-2xl bg-soft-oatmeal/10 hover:bg-soft-oatmeal/30 transition-all font-bold group">
                       <div className="flex items-center gap-3">
                          <FiSettings className="text-warm-sand group-hover:rotate-45 transition-transform" />
                          <span className="text-sm">Account Settings</span>
                       </div>
                    </button>
                    <button className="w-full flex items-center justify-between p-4 rounded-2xl bg-soft-oatmeal/10 hover:bg-soft-oatmeal/30 transition-all font-bold group">
                       <div className="flex items-center gap-3">
                          <FiEdit2 className="text-warm-sand" />
