...
const orderDetails = {
  ...
  2: {
    ...
    shippingAddress: "45, Garden Towers, Whitefield, Bangalore - 560066",
    paymentMethod: "UPI (Paytm)",
    items: [
      { id: 3, name: "Designer Wall Sconce", quantity: 2, price: 1249.5, image: "https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?w=400" }
    ],
    subtotal: 2499,
    shipping: 0,
    total: 2499,
    timeline: [
      { status: "Order Placed", date: "2024-04-14 02:15 PM", active: true },
      { status: "Payment Confirmed", date: "2024-04-14 02:20 PM", active: true },
      { status: "Processing", date: "2024-04-14 03:00 PM", active: true },
      { status: "Shipped", date: "", active: false },
      { status: "Out for Delivery", date: "", active: false },
      { status: "Delivered", date: "", active: false }
    ]
  ...
  3: {
    ...
    shippingAddress: "B-204, Skyline Apartments, Sector 15, Gurgaon - 122001",
    paymentMethod: "Net Banking",
    items: [
      { id: 4, name: "Modern Coffee Table", quantity: 1, price: 8999, image: "https://images.unsplash.com/photo-1544457070-4cd783ba4120?w=400" }
    ],
    subtotal: 8999,
    shipping: 0,
    total: 8999,
    timeline: [
      { status: "Order Placed", date: "2024-04-13 09:00 AM", active: true },
      { status: "Payment Confirmed", date: "2024-04-13 09:10 AM", active: true },
      { status: "Processing", date: "2024-04-13 11:30 AM", active: true },
      { status: "Shipped", date: "2024-04-14 10:00 AM", active: true },
      { status: "Out for Delivery", date: "", active: false },
      { status: "Delivered", date: "", active: false }
    ]
  }
