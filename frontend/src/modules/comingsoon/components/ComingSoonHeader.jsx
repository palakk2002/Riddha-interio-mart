  ...
  return (
    <nav className="h-16 flex items-center justify-between px-8 bg-white/70 backdrop-blur-xl sticky top-0 z-50 border-b border-slate-100/50">
      ...
      <button 
        ...
        className="hidden md:flex px-6 py-2.5 bg-[#311B92] text-white rounded-xl font-black uppercase tracking-widest text-[10px] shadow-xl shadow-indigo-900/20 hover:scale-105 transition-all active:scale-95"
      >
        Contact Us
      </button>
      ...
      <div className="md:hidden">
         <Link to="/coming-soon/categories" className="py-2 px-3 bg-slate-50 rounded-lg text-[#311B92]">
