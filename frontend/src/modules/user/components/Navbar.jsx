          ...
          <div className="flex md:hidden justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Link to="/cart" className="p-2 text-white/80 relative">
                ...
                {cartCount > 0 && <span className="absolute top-1 right-1 bg-white text-red-800 text-[8px] font-bold h-4 w-4 flex items-center justify-center rounded-full">{cartCount}</span>}
              </Link>
                    ...
                    <div className="grid grid-cols-4 lg:grid-cols-5 gap-12">
                      <div className="flex flex-col gap-6">
                        <h3 className="text-red-800 font-bold text-sm uppercase tracking-wide border-b border-gray-100 pb-2">
                          {categories.find(c => c._id === activeCategory).name} Types
                        </h3>
