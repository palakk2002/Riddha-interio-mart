                  ...
                  >
                    {currentBanner.primaryBtnText && (
                      <BannerAction
                        ...
                        className="px-5 md:px-7 py-2.5 md:py-3 rounded-full bg-[#922724] text-white text-[11px] md:text-sm font-bold tracking-wide hover:bg-[#7a1f1d] transition-colors"
                      >
                        {currentBanner.primaryBtnText}
                      </BannerAction>
                    )}
                    {currentBanner.secondaryBtnText && (
                      <BannerAction
                        ...
                        className="px-5 md:px-7 py-2.5 md:py-3 rounded-full border border-white/70 text-white text-[11px] md:text-sm font-bold tracking-wide hover:bg-white/10 transition-colors"
                      >
                        {currentBanner.secondaryBtnText}
                      </BannerAction>
                    )}
