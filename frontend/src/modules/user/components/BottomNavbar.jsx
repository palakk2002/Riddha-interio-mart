                  ...
                  <AnimatePresence>
                    {item.badge > 0 && (
                      <motion.span 
                        ...
                        className="absolute -top-2.5 -right-2.5 bg-warm-sand text-white text-[9px] font-black h-5 w-5 flex items-center justify-center rounded-full shadow-[0_4px_12px_rgba(191,163,138,0.4)] border-2 border-white"
                      >
                        {item.badge}
                      </motion.span>
                    )}
