        ...
        <div className="relative z-10 space-y-1.5 flex-1 pl-1 md:pl-2">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-[15px] md:text-3xl font-display font-bold text-[#189D91] tracking-tight leading-none">
              Express Delivery in <span className="underline decoration-wavy decoration-[#D4A017]/40 underline-offset-4 text-[#D4A017]">4 hours</span>
            </h2>
          </div>

          <div className="space-y-0.5">
            <p className="text-[#189D91]/80 text-[11px] md:text-lg font-semibold leading-tight">
              Order before <span className="text-[#189D91] font-bold">6 PM</span> for <span className="text-[#D4A017] font-bold">4hr delivery*</span>
            </p>
